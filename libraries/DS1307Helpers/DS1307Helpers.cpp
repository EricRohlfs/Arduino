/* 
* Converted to a class by Eric Rohlfs 2015
 *
 * RTC Control v1.00 
...
byte DS1307Helpers:decToBcd(byte val)
{
  return ( (val/10*16) + (val%10) );
}
 
// Convert binary coded decimal to normal decimal numbers
byte DS1307Helpers:bcdToDec(byte val)
{
...
void DS1307Helpers:setDateDs1307()                
{
...
void DS1307Helpers:getDateDs1307()
{
